...
if "resources_list" not in st.session_state:
    st.session_state.resources_list = [
        {"Berater": "Max Mustermann", "Rolle": "Senior Cloud Architect", "Auslastung (%)": 110, "Hauptprojekt": "Cloud Migration Azure", "Status": "Überlastet "},
...
def calculate_risk(row):
    ...
    if budget_used > 100:
        ...
        return " Kosten laufen Fortschritt davon", "Medium"
    else:
...
with tab2:
    ...
    fig_res = px.bar(df_resources, x='Berater', y='Auslastung (%)', color='Status',
                     color_discrete_map={'Optimal ': '#2E7D32', 'Überlastet ': '#ED6C02', 'Kritisch Überlastet ': '#D32F2F', 'Kapazität frei ': '#0288D1'},
